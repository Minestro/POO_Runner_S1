...
enum button_action {CHANGE_PAGE, EXIT_APP, SET_FULL_SCREEN, RESUME_GAME, RESET_GAME, SET_SELECTED, ERASE_SAVE, LOAD_SAVE, REFRESH_VIEW_BUTTONS, SET_PLAYER_NAME, SAVE_GAME_BUTTON, SET_MUSIC, SET_SOUNDS};
