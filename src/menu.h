...
enum menu_specific_elements {FULL_SCREEN_BUTTON = 200, MUSIC_ACTIVE_BUTTON, SOUNDS_ACTIVE_BUTTON, LOAD_SAVE_BUTTON, ERASE_SAVE_BUTTON, INPUT_TEXT, SELECT_SAVE_1, SELECT_SAVE_2, SELECT_SAVE_3, SELECT_SAVE_4, SELECT_SAVE_5};
